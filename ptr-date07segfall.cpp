...
char* Date :: getDayOfWeek()
{
    ...
    char dayOfWeek[][10] = {"Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday"};
    int dayCalc;
...
void testDate07()
{
    //Creates d1 object with instructed values
    Date d1;
    d1.setMonth(3);
    d1.setDay(5);
    d1.setYear(1999);
    ...
    //Creates d2 object with instructed values
    Date d2;
    d2.setMonth(4);
    d2.setDay(6);
    d2.setYear(2000);
